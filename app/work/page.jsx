...
const projects = [
  {
    ...
    title: "project 1",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo corporis hic, voluptatum unde doloribus sequi inventore quos quasi molestias!",
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              {/* slider buttons */}
              <WorkSliderBtns
                contaionerStyles="flex gap-2 absolute right-0 bottom-[calc(50%_-_22px)] xl:bottom-0 z-20 w-full justify-between xl:w-max xl:justify-none"
